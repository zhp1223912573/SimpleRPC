...
public abstract class AbstracLoadBalance implements LoadBalance{
    ...
    @Override
    public String selectServiceAddress(List<String> serviceUrlList, RpcReuqest rpcReuqest) {
        ...
        return doSelect(serviceUrlList,rpcReuqest);
     ...
     * @return
     */
    protected abstract String doSelect(List<String> serviceUrlList, RpcReuqest rpcReuqest);
}
